            ...
            <CarouselContent>
                ...
                {result !== null &&(
                    result.map((product: ProductType) => {
                        ...
                        const {slug, images, productName, genero, origin} = attributes

                        return(
                            <CarouselItem key={id} className="md:basis-1/2 lg:basis-1/3 group">
                                <div className="p-1">
                                    <Card className="py-4 border border-gray-200 shadow-none">
                                        <CardContent className="relative flex items-center justify-center px-6 py-2 overflow-hidden">
                                        ...
                                        <div className="flex justify-between gap-4 px-8 overflow-hidden">
                                            ...
                                            <p className="px-1 py-0.5 text-white bg-black rounded-full dark:bg-white dark:text-black w-fit ">{genero}</p>
                                            <p className="px-1 py-0.5 text-white bg-yellow-900 rounded-full w-fit ">{origin}</p>
                                            </div>
                                        </div>
                                    </Card>
                                </div>
